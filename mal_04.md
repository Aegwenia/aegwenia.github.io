...
mal_p eval_if(lvm_p this, mal_p ast, env_p env);
...
text_p list_text(lvm_p this, list_p list)
{
  ...
  if (list->count > 0) {
    ...
    if (text_cmp(this, mal_print(this, list->data[at], false), "nil")) {
...
text_p vector_text(lvm_p this, vector_p vector)
{
  ...
  if (vector->count > 0) {
    ...
    if (text_cmp(this, mal_print(this, vector->data[at], false), "nil")) {
      text_concat(this, mal, " : ");
      text_concat_text(this, mal, mal_print(this, vector->data[at], false));
    }
  }
...
text_p mal_print(lvm_p this, mal_p mal, bool readable)
{
  ...
  case MAL_VECTOR:
    ...
    if (mal->as.vector->count > 0) {
      ...
      if (!is_nil(mal->as.vector->data[i])) {
        text_concat(this, text, " : ");
        text_concat_text(this, text, mal_print(this,
...
mal_p eval_let_star(lvm_p this, mal_p ast, env_p outer)
{
  ...
  env_p env = env_make(this, outer, NULL, NULL, NULL, 0);
  size_t at;
...
mal_p eval_if(lvm_p this, mal_p ast, env_p env)
{
  ...
  if (is_false(condition) || is_nil(condition)) {
    if (!is_nil(list->data[3])) {
      return lvm_eval(this, list->data[3], env);
    } else {
      mal_p nil;
    ...
    return lvm_eval(this, list->data[2], env);
  }
}
...
mal_p eval_do(lvm_p this, mal_p ast, env_p env)
{
  ...
  if (is_nil(list->data[at])) {
    ...
    return lvm_eval(this, list->data[at], env);
  }
}
...
mal_p lvm_eval(lvm_p this, mal_p ast, env_p env)
{
  ...
  case MAL_CLOSURE:
    ...
    if (arity > arguments) {
      ...
      inner = env_make(this, closure->env, parameters, params,
          closure->more, 0);
      return lvm_eval(this, closure->definition, inner);
    }
  case MAL_HASHMAP:
